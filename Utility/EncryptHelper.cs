...
namespace System
{
    ...
    public static class EncryptHelper
    {
        ...
        /// <param name="key">加密密钥</param>
        /// <returns>加密后的字符串</returns>
        public static string EncryptStr(this string str, string key = "logincookie")
        {
            var des = DES.Create();
        ...
        public static string DecryptStr(this string str, string key = "logincookie")
        {
            var des = DES.Create();
        ...
        /// <returns></returns>
        public static string EncryptCookie(string QueryString)//标准的DES加密  关键字、数据加密
        {
            return CookieEncrypt(QueryString, _QueryStringKey);
        }
        /// <summary>
        /// 解密
        /// </summary>
        ...
        /// <returns></returns>
        public static string DecryptCookie(string QueryString)//标准的DES解密
        {
            return Decrypt(QueryString, _QueryStringKey);
        }
        //URL传输参数加密Key这个key可以自己设置支持8位这个东西很重要的,密钥
        static string _QueryStringKey = "14562889";

        public static string CookieEncrypt(string originalString, string sKey)
        {
            try
            {
